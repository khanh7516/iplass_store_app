            ...
            <nav class="navbar navbar-expand-lg navbar-custom">
              ...
              <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link btn btn-login" href="http://127.0.0.1:5500/login.html"><i class="fa-regular fa-circle-user"></i> <br>
                      Đăng nhập</a>
                  </li>
                </ul>
              </div>
            ...
            <div class="row product-details">
                ...
                <div class="col-md-5">
                    ...
                    <div style="width: 100%;" class="btn-group">
                        ...
                        <button onclick="addToCart()" style="width: 30%;" class="btn btn-light"><i class="fa-solid fa-cart-plus"></i> <br>Thêm vào giỏ</button>
                    </div>
                </div>
            </div>
